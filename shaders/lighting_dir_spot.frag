...
void main()
{
    ...
    // if the light isn't on then return 0 for diffuse and specular colors
    if (spotLight.on == 1)
...
// calculate the direction light effect and return resulting
// difuse and specular color summation 
vec3 calcDirectionalLightColor(DirectionalLight light, vec3 normal, vec3 viewDir)
{
