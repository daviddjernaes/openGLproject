...
int main()
{
    ...
    while (!glfwWindowShouldClose(gWindow))
    {
        ...
        lightingShader.setUniform("pointLights[0].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm light
        ...
        lightingShader.setUniform("pointLights[1].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        ...
        // Point Light LL3
        lightingShader.setUniform("pointLights[2].ambient", glm::vec3(0.8f, 0.8f, 0.8));
        lightingShader.setUniform("pointLights[2].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        ...
        lightingShader.setUniform("pointLights[3].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        ...
        lightingShader.setUniform("pointLights[3].linear", 0.22f);
        lightingShader.setUniform("pointLights[3].exponent", 0.20f);

        // point light L1
        lightingShader.setUniform("pointLights[4].ambient", glm::vec3(0.8f, 0.8f, 0.8f));
        lightingShader.setUniform("pointLights[4].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm light
        ...
        // Point Light R1
        lightingShader.setUniform("pointLights[5].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[5].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[5].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[5].position", pointLightPos[5]);
        lightingShader.setUniform("pointLights[5].constant", 1.0f);
        lightingShader.setUniform("pointLights[5].linear", 0.22f);
        lightingShader.setUniform("pointLights[5].exponent", 0.20f);

        // Point Light RR1
        lightingShader.setUniform("pointLights[6].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[6].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[6].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[6].position", pointLightPos[6]);
        lightingShader.setUniform("pointLights[6].constant", 1.0f);
        lightingShader.setUniform("pointLights[6].linear", 0.22f);
        lightingShader.setUniform("pointLights[6].exponent", 0.20f);

        // Point Light RR2
        lightingShader.setUniform("pointLights[7].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[7].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[7].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[7].position", pointLightPos[7]);
        lightingShader.setUniform("pointLights[7].constant", 1.0f);
        lightingShader.setUniform("pointLights[7].linear", 0.22f);
        lightingShader.setUniform("pointLights[7].exponent", 0.20f);

        // Point Light RR3
        lightingShader.setUniform("pointLights[8].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[8].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[8].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[8].position", pointLightPos[8]);
        lightingShader.setUniform("pointLights[8].constant", 1.0f);
        lightingShader.setUniform("pointLights[8].linear", 0.22f);
        lightingShader.setUniform("pointLights[8].exponent", 0.20f);

        // Point Light RR4
        lightingShader.setUniform("pointLights[9].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[9].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[9].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[9].position", pointLightPos[9]);
        lightingShader.setUniform("pointLights[9].constant", 1.0f);
        lightingShader.setUniform("pointLights[9].linear", 0.22f);
        lightingShader.setUniform("pointLights[9].exponent", 0.20f);

        // point light BLL1
        lightingShader.setUniform("pointLights[10].ambient", glm::vec3(0.8f, 0.8f, 0.8f));
        lightingShader.setUniform("pointLights[10].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm light
        lightingShader.setUniform("pointLights[10].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[10].position", pointLightPos[10]);
        lightingShader.setUniform("pointLights[10].constant", 1.0f);
        lightingShader.setUniform("pointLights[10].linear", 0.22f);
        lightingShader.setUniform("pointLights[10].exponent", 0.20f);

        // Point Light BLL2
        lightingShader.setUniform("pointLights[11].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[11].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[11].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[11].position", pointLightPos[11]);
        lightingShader.setUniform("pointLights[11].constant", 1.0f);
        lightingShader.setUniform("pointLights[11].linear", 0.22f);
        lightingShader.setUniform("pointLights[11].exponent", 0.20f);

        // Point Light BLL3
        lightingShader.setUniform("pointLights[12].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[12].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[12].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[12].position", pointLightPos[12]);
        lightingShader.setUniform("pointLights[12].constant", 1.0f);
        lightingShader.setUniform("pointLights[12].linear", 0.22f);
        lightingShader.setUniform("pointLights[12].exponent", 0.20f);

        // Point Light BLL4
        lightingShader.setUniform("pointLights[13].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[13].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[13].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[13].position", pointLightPos[13]);
        lightingShader.setUniform("pointLights[13].constant", 1.0f);
        lightingShader.setUniform("pointLights[13].linear", 0.22f);
        lightingShader.setUniform("pointLights[13].exponent", 0.20f);

        // Point Light BRR1
        lightingShader.setUniform("pointLights[14].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[14].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[14].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[14].position", pointLightPos[14]);
        lightingShader.setUniform("pointLights[14].constant", 1.0f);
        lightingShader.setUniform("pointLights[14].linear", 0.22f);
        lightingShader.setUniform("pointLights[14].exponent", 0.20f);

        // Point Light BRR2
        lightingShader.setUniform("pointLights[15].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[15].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[15].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[15].position", pointLightPos[15]);
        lightingShader.setUniform("pointLights[15].constant", 1.0f);
        lightingShader.setUniform("pointLights[15].linear", 0.22f);
        lightingShader.setUniform("pointLights[15].exponent", 0.20f);

        // Point Light BRR3
        lightingShader.setUniform("pointLights[16].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[16].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[16].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[16].position", pointLightPos[16]);
        lightingShader.setUniform("pointLights[16].constant", 1.0f);
        lightingShader.setUniform("pointLights[16].linear", 0.22f);
        lightingShader.setUniform("pointLights[16].exponent", 0.20f);

        // Point Light BRR4
        lightingShader.setUniform("pointLights[17].ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        lightingShader.setUniform("pointLights[17].diffuse", glm::vec3(0.9373f, 0.9216f, 0.8417f));	// warm-ish light
        lightingShader.setUniform("pointLights[17].specular", glm::vec3(1.0f, 1.0f, 1.0f));
        lightingShader.setUniform("pointLights[17].position", pointLightPos[17]);
        lightingShader.setUniform("pointLights[17].constant", 1.0f);
        lightingShader.setUniform("pointLights[17].linear", 0.22f);
        lightingShader.setUniform("pointLights[17].exponent", 0.20f);
